...
<Velocity11 file='Protocol_Data' md5sum='69b6398a9bbd3c18ae678a816626d4af' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='0' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='open( &apos;C:/VWorks Workspace/Protocol Files/truseq-stranded-mrna/truseq_startup_v1201.js&apos;);
...
var statusString = &quot;Preparing runset&quot;;' />
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Define' />
				</Plate_Parameters>
		...
		<Main_Processes >
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Process' />
